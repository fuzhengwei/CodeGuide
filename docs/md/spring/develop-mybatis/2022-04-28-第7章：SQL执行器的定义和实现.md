...
- [之前对数据源的使用、执行SQL、封装结果，都耦合在DefaultSqlSession#selectOne方法中 @liuc](https://t.zsxq.com/08svosiof)
- [Sql执行器的定义和实现 @小猪碎碎念](https://t.zsxq.com/0bXbxKHvd)
- [在以后写代码需要考虑到代码的解耦，能够把Excutor这种设计思想应用到实际的业务代码中](https://t.zsxq.com/0ceTgynZc)
- [解耦，对于流程的解耦 @AD钙奶](https://t.zsxq.com/107WusqQD)