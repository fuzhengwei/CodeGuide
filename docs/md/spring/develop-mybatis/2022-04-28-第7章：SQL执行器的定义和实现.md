...
![图 7-1 DefaultSqlSession 调用数据源](/Users/fuzhengwei/Desktop/mybatis-220428-01.png)
...
![图 7-2 引入执行器解耦设计](/Users/fuzhengwei/Desktop/mybatis-220428-02.png)
...
![图 7-3 SQL方法执行器核心类关系](/Users/fuzhengwei/Desktop/mybatis-220428-03.png)
...
- 在语句处理器基类中，讲参数信息、结果信息进行封装处理。不过暂时这里我们还不会做过多的参数处理，包括jdbc的字段类型转换等。这部分内容随着我们整个执行器的结构建设完毕后，再进行迭代开发。
...
![](/Users/fuzhengwei/Desktop/mybatis-220428-04.png)
