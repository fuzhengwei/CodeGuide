...
![](https://bugstack.cn/images/article/algorithm/heap-01.png)

- 最大堆：与最小堆的定义正好相反，最大堆(max heap) , `P` 的key(或value)大于 `C` 的对应值。

![](https://bugstack.cn/images/article/algorithm/heap-02.png)
...
![](https://bugstack.cn/images/article/algorithm/heap-03.png)
...
![](https://bugstack.cn/images/article/algorithm/heap-04.png)
