...
- 应用分支：[211003_xfg_ApplicationActivityProcess](https://codechina.csdn.net/KnowledgePlanet/Lottery/-/tree/211003_xfg_ApplicationActivityProcess)
- 路由组件：[db-router-spring-boot-starter `打包最新路由组件包`](https://codechina.csdn.net/KnowledgePlanet/db-router-spring-boot-starter)
...
![](/images/article/project/lottery/12-01.png)
